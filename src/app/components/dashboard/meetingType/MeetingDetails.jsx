...
const MeetingDetails = ({ meetingDetails }) => {
  ...
  return (
    <div className="flex flex-col shadow-lg  backdrop-opacity-70 rounded-lg  md:flex-row gap-8 items-start p-4 font-raleway">
      <div className="border-t-0 bg-gray-800 opacity-90 text-slate-50 card glass border-b-0  border-l-0 border-2 border-dashed border-r-orange-500  border-t-orange-500  p-4 w-full md:w-1/3 mb-4 h-full flex-grow min-h-[400px]">
        <h2 className="text-2xl font-bold mb-4 text-green-500">Meeting Details 📋</h2>
        {meetingDetails ? (
      ...
      <div className=" border-t-0 bg-gray-800 opacity-90 card glass font-raleway border-l-0 border-b-0 border-2 border-dashed border-r-blue-500  p-4 w-full md:w-1/3 mb-4 h-full flex-grow min-h-[400px]">
        <h2 className="text-2xl font-bold mb-4 text-green-500">Select Your Date 📅</h2>
