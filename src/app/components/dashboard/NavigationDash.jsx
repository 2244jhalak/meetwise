    ...
    return (
        <div className="group font-raleway">
            <Link href={address}
                ...
                className="flex w-full rounded-xl items-center px-4 py-2 mt-5 text-white hover:bg-green-700 hover:text-white transform transition-all duration-500 ease-in font-raleway"
            >
