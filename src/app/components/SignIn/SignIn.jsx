...
const SignIn = () => {
    return (
        <div className="md:flex justify-between my-10 lg:px-28 md:px-10 px-5">
            <div className="max-w-96 lg:mt-24 md:mt-20">
                <img src="https://i.postimg.cc/MTYBf7s3/Online-calendar-amico-1.png" alt="" />
            </div>
            <div className="bg-violet-100 w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <form noValidate="" action="" className="space-y-6">
                    ...
                    <button className="block bg-[#6b579c] text-white w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-default-600">Sign in</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-600">Don't have an account?
                    <a rel="noopener noreferrer" href="#" className="underline dark:text-gray-800 text-red-500">Sign up</a>
                </p>
            </div>
        </div>
