    ...
    try {
      ...
      if (imgbbData.success) {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_CLIENT_URL}/signup/api`,
          {
            method: "POST",
            headers: {
  ...
  return (
    <div className="container mx-auto pb-5 ">
      <div className="flex flex-col gap-2 md:flex-row items-center justify-center">
        {/* left side  */}
        <div className="md:w-1/2 min-h-screen md:pt-10 ">
            ...
            <form onSubmit={handleSubmit} className="card-body">
              ...
              <div className="form-control relative">
                ...
                <p
                  ...
                  className="absolute top-[64%] left-[82%] md:left-[85%]"
                >
                  {showpassword ? (
                    <FaEyeSlash className="h-[100%] text-black" />
                  ) : (
                    <FaEye className="h-[100%] text-black"></FaEye>
                  )}
                </p>
              </div>
              <div className="form-control relative">
