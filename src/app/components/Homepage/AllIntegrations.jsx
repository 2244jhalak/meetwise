...
const AllIntegrations = () => {
    ...
    return (
        <div className='bg-black/20 md:py-16 md:px-28 p-5 text-center mx-auto' data-aos="fade-down">
            ...
            <div className='md:flex justify-between gap-5 mx-auto '>
                <div className='bg-white p-7 lg:w-96 pr-5 md:w-[370px] rounded-2xl shadow-2xl text-start mt-5 lg:hover:scale-105 animate__animated animate__zoomIn hover:shadow-black'>
