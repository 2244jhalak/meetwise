...
const AllIntegrations = () => {
    ...
    return (
        <div className='container border-2 border-r-0 border-l-0 border-b-0 border-t-orange-500 md:py-16 md:px-28 p-5 text-center mx-auto bg-black/30 backdrop-blur-md backdrop-opacity-70 rounded-t-xl shadow-t-xl mt-2' data-aos="fade-down">
            ...
            <div className='md:flex justify-between gap-5 mx-auto '>
                <div className='bg-green-100 p-7 lg:w-96 pr-5 md:w-[370px] rounded-2xl shadow-xl text-start mt-5 lg:hover:scale-105 animate__animated animate__zoomIn hover:shadow-green-900'>
