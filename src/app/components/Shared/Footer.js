...
//   return (
//     <div className="bg-white/10 backdrop-blur-md backdrop-opacity-70 text-gray-400">
//       <footer className="footer p-14 lg:px-40 text-gray-400">
//         <aside>
//           <Image
//             className="w-[75px] bg-white rounded-full -mt-8 -mb-14"
//             src={logo}
//             alt="MeetWise Logo"
//           />
...
//           <div className="footer-title text-white">{content[language].socialMedia}</div>
...
//                 className="w-5 h-5 fill-current"
//               >
//                 <path d="M16 6c-5.514 0-10 4.486-10 10s4.486 10 10 10 10-4.486 10-10-4.486-10-10-10zM16 24c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zM25.5 9c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5z"></path>
//                 <path d="M26 0h-20c-3.313 0-6 2.687-6 6v20c0 3.313 2.687 6 6 6h20c3.313 0 6-2.687 6-6v-20c0-3.313-2.687-6-6-6zM30 26c0 2.206-1.794 4-4 4h-20c-2.206 0-4-1.794-4-4v-20c0-2.206 1.794-4 4-4h20c2.206 0 4 1.794 4 4v20z"></path>
//               </svg>
//             </a>
//           </div>
//         </div>
      ...
      <footer className="footer p-14  lg:px-40 text-gray-400">
        ...
        <nav className="flex">
          <nav>
            ...
            <br />
            <a className="link link-hover" href="/"> {content[language].meetWiseAI}</a>
            <br />
          ...
          <nav className='ml-20'>
            ...
            <br />
            <a className="link link-hover" href="/"> {content[language].mission}</a>
            <br />
            <a className="link link-hover" href="/"> {content[language].pricing}</a>
          </nav>
        </nav>
        <nav className=''>
          <h6 className="footer-title text-white">{content[language].resources}</h6>
